...
console.log(createMenuItem('French Fries', '8', 'Snack'));
console.log(createMenuItem('Salad', '13', 'Lunch'));
...
burger.discount = function (string) {
  if (string === "teacher" || string === "student") {
    console.log(burger.price * .75);
  } else if (string === "public") {
    console.log(burger.price * .9);
  }
}
...
reviews.push({name: "Josh", rating: 4, feedback: "A perfectly adequate restaurant. Would go again."})
console.log(reviews);
...
//reviews.push({name: "Test", rating: 3, feedback: "test feedback"});
